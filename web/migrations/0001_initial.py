    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(help_text='如果auth_type选择为ssh-key,那么此处应该为key 的路径', max_length=256)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system_type', models.CharField(choices=[(0, 'linux'), (1, 'Windows')], default='0', max_length=1)),
                ('memo', models.CharField(blank=True, max_length=128, null=True)),
