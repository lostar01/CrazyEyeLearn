function get_connect_info() {
    ...
    var bhid = $.trim($('#bh_id').html());
    var djuser = $.trim($('#dj_user').html())
    var token = $.trim($('#token').html())
    ...
    var connect_info1 = 'host=' + host + '&port=' + port + '&bhid=' + bhid + '&djuser=' + djuser + '&token=' + token + '&user=' + user + '&auth=' + auth;
